...
namespace UI.PauseScreen
{
    public class PauseScreenDialogue : Dialogue
    {
        ...
        public void Exit()
        {
            ...
            exitConfirmedPrefabInstance.GetComponentsInChildren<Button>()[0].onClick.
                AddListener(CancelExit);
            exitConfirmedPrefabInstance.GetComponentsInChildren<Button>()[1].onClick.
                AddListener(ConfirmExit);
        }
