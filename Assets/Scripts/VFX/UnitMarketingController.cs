...
namespace VFX.VFX
{
    public class UnitMarketingController : MonoBehaviour
    {
        ...
        {
            SpawnUnits(players.Values, 1);
            HideUnits(players.Values, 3);

            SpawnUnits(enemies.Values, 5);
            HideUnits(enemies.Values, 7);
        }
